...
func NewInsertAndMergeFlashCardSetsTrackerHandler(
	insertAndMergeFlashCardSetsTrackerFunc InsertAndMergeFlashCardSetsTrackerFunc,
) fiber.Handler {

	return func(c *fiber.Ctx) error {
		var (
			req FlashCardSetsTrackerUpsert
		)
		ctx := c.Context()
