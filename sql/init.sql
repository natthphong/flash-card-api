...
(
    ...
    status varchar(50), --PENDING -- APPROVED --REJECT
...
(
    id          serial PRIMARY KEY,
    owner_id    int REFERENCES tbl_users (id),
    title       varchar(255),
    description text,
...
-- );
--
-- CREATE TABLE tbl_group_class_members (
--   group_id      int         REFERENCES tbl_group_classes(id) ON DELETE CASCADE,
--   user_id       int         REFERENCES tbl_users(id),
--   PRIMARY KEY (group_id, user_id)
-- );
--
-- CREATE TABLE tbl_group_class_study_classes (
--   group_id      int         REFERENCES tbl_group_classes(id) ON DELETE CASCADE,
--   class_id      int         REFERENCES tbl_study_classes(id) ON DELETE CASCADE,
...
-- user progress for spaced
-- CREATE TABLE tbl_user_flashcard_progress (
--   user_id       int         REFERENCES tbl_users(id),
--   card_id       bigint      REFERENCES tbl_flashcards(id),
--   next_review   date,
--   last_score    smallint,
...
-- CREATE INDEX idx_tbl_group_class_members_user_id
--   ON tbl_group_class_members(user_id);
--
-- CREATE INDEX idx_tbl_group_class_study_classes_class_id
--   ON tbl_group_class_study_classes(class_id);
...
-- -- Progress & scheduling
-- CREATE INDEX idx_tbl_user_flashcard_progress_next_review
--   ON tbl_user_flashcard_progress(next_review);
